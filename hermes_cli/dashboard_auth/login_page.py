...
<title>Sign in — Seple T Agent</title>
<style>
...
<body>
<main>
  <div class="brand">Nova<span class="dot"></span>Edge</div>
  <div class="card">
    <h1>Sign in</h1>
    <p class="subtitle">Choose a sign-in method to continue to the Seple T Agent dashboard.</p>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Sign-in unavailable — Seple T Agent</title>
<style>
  @font-face {
    font-family: 'Collapse';
    font-style: normal;
