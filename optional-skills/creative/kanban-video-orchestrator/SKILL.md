...
6. **The director never executes.** Even with the full `kanban + terminal +
   ...
   a `Seple T Agent kanban create` call to a specialist profile. The kanban
