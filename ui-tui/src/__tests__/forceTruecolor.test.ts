...
describe('forceTruecolor', () => {
  ...
  it('respects existing FORCE_COLOR unless Seple T Agent truecolor is explicit', async () => {
    await withCleanEnv(
      () => {
  ...
  it('lets explicit Seple T Agent truecolor override existing FORCE_COLOR', async () => {
    await withCleanEnv(
      () => {
