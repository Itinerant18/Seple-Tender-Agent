...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Seple T Agent Teal",
  description: "Classic dark teal — the canonical Seple T Agent look",
  palette: {
...
/** Light mode — vivid Novaedge-blue accents on a cream canvas. */
export const nousBlueTheme: DashboardTheme = {
  name: "nous-blue",
  label: "Novaedge Blue",
  description: "Light mode — vivid Novaedge-blue accents on cream canvas",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Seple T Agent Teal (Large)",
  description: "Seple T Agent Teal with bigger fonts and roomier spacing",
