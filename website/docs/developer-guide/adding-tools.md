...
sidebar_position: 2
title: "Adding Tools"
description: "How to add a new tool to Seple T Agent — schemas, handlers, registration, and toolsets"
---
...
This page is for adding a **built-in Seple T Agent tool** to the repository itself.
If you want a personal, project-local, or otherwise custom tool without
modifying Seple T Agent core, use the plugin route instead:

- [Plugins](/user-guide/features/plugins)
- [Build a Seple T Agent Plugin](/developer-guide/plugins)
...
- [ ] Tested with `Seple T Agent chat -q "Use the weather tool for London"`
