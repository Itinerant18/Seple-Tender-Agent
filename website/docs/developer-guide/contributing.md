...
sidebar_position: 4
title: "Contributing"
description: "How to contribute to Seple T Agent — dev setup, code style, PR process"
---

# Contributing

Thank you for contributing to Seple T Agent! This guide covers setting up your dev environment, understanding the codebase, and getting your PR merged.
...
- Building a custom/local tool without modifying Seple T Agent core? Start with [Build a Seple T Agent Plugin](../developer-guide/plugins/index.md)
- Building a new built-in core tool for Seple T Agent itself? Start with [Adding Tools](./adding-tools.md)
...
You can also run a fully isolated Seple T Agent instance (throwaway HERMES_HOME, separate Electron
...
echo 'OPENROUTER_API_KEY=sk-or-v1-your-key' >> ~/.Seple T Agent/.env
```
...
- **Profile-safe paths**: Never hardcode `~/.Seple T Agent` — use `get_hermes_home()` from `hermes_constants` for code paths and `display_hermes_home()` for user-facing messages. See [AGENTS.md](https://github.com/Novaedge/hermes-agent/blob/main/AGENTS.md#profiles-multi-instance-support) for full rules.
...
- Use [GitHub Issues](https://github.com/Novaedge/hermes-agent/issues)
...
- **Discord**: [discord.gg/Novaedge](https://discord.gg/Novaedge)
- **GitHub Discussions**: For design proposals and architecture discussions
- **Skills Hub**: Upload specialized skills and share with the community

## License

By contributing, you agree that your contributions will be licensed under the [MIT License](https://github.com/Novaedge/hermes-agent/blob/main/LICENSE).
