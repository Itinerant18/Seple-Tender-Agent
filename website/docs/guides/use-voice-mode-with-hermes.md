---
sidebar_position: 8
title: "Use Voice Mode with Seple T Agent"
description: "A practical guide to setting up and using Seple T Agent voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with Seple T Agent
...
- you want Seple T Agent sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in Seple T Agent.
...
## Step 1: make sure normal Seple T Agent works first

Before touching voice mode, verify that:
- Seple T Agent starts
...
Seple T Agent supports both local and cloud speech stacks.
...
4. Seple T Agent transcribes and responds
...
- asking Seple T Agent to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full Seple T Agent loop.

## Tuning CLI behavior

### Silence threshold

If Seple T Agent starts/stops too aggressively, tune:
...
Seple T Agent stays a normal chat bot, but can speak replies.
...
- you want Seple T Agent to function like a portable research or ops assistant
...
Seple T Agent joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- Seple T Agent detects speech boundaries
- transcripts are posted in the associated text channel
- Seple T Agent responds in text and audio
...
1. get text Seple T Agent working
