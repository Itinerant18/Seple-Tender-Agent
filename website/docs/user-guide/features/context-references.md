...
Type `@` followed by a reference to inject content directly into your message. Seple T Agent expands the reference inline and appends the content under an `--- Attached Context ---` section.
...
- Seple T Agent env: `$HERMES_HOME/.env`
