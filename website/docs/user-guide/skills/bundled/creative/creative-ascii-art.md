...
```bash
python3 -m pyfiglet "Seple T Agent" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=Seple T Agent&font=Slant" | boxes -d stone
```
