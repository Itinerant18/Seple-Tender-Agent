...
| | |
|---|---|
| Source | Optional — install with `Seple T Agent skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Seple T Agent |
| License | MIT |
...
The script reads `${HERMES_HOME:-~/.Seple T Agent}/.env` for two optional defaults:
...
Helper script: `~/.Seple T Agent/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.Seple T Agent/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${HERMES_HOME:-~/.Seple T Agent}/.env`.
...
```bash
python3 ~/.Seple T Agent/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.Seple T Agent/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
