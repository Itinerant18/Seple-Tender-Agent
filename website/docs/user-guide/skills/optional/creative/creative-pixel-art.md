...
| | |
|---|---|
| Source | Optional — install with `Seple T Agent skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.Seple T Agent/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.Seple T Agent/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Seple T Agent installs package this)
