...
| | |
|---|---|
| Source | Optional — install with `Seple T Agent skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Seple T Agent |
| License | MIT |
...
```
SCRIPT=~/.Seple T Agent/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.Seple T Agent/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
