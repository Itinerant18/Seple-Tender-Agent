...
| | |
|---|---|
| Source | Optional — install with `Seple T Agent skills install official/health/neuroskill-bci` |
...
Connect Seple T Agent to a running [NeuroSkill](https://neuroskill.com/) instance to read
