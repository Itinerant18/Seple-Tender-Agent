...
| | |
|---|---|
| Source | Optional — install with `Seple T Agent skills install official/productivity/canvas` |
...
4. Name the token (e.g., "Seple T Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `${HERMES_HOME:-~/.Seple T Agent}/.env`:
