...
| | |
|---|---|
| Source | Optional — install with `Seple T Agent skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research/darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), Seple T Agent |
| License | MIT |
...
import upstream classes into Seple T Agent itself.
...
```bash
mkdir -p ~/.Seple T Agent/cache/darwinian-evolver && cd ~/.Seple T Agent/cache/darwinian-evolver
...
```bash
cd ~/.Seple T Agent/cache/darwinian-evolver/darwinian_evolver \
...
Open `~/.Seple T Agent/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
SKILL_DIR=~/.Seple T Agent/skills/research/darwinian-evolver
DE_DIR=~/.Seple T Agent/cache/darwinian-evolver/darwinian_evolver
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Seple T Agent core.
   Custom driver scripts under `~/.Seple T Agent/skills/...` are user-side and fine.
