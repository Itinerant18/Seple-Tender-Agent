...
| | |
|---|---|
| Source | Optional — install with `Seple T Agent skills install official/research/qmd` |
...
Seple T Agent via the native MCP client. This is the preferred
...
Then configure Seple T Agent to connect via HTTP:
