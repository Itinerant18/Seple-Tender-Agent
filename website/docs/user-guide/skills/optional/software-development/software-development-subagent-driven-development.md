...
| | |
|---|---|
| Source | Optional — install with `Seple T Agent skills install official/software-development/subagent-driven-development` |
| Path | `optional-skills/software-development/subagent-driven-development` |
| Version | `1.1.0` |
| Author | Seple T Agent (adapted from obra/superpowers) |
| License | MIT |
