...
- User wants **Seple T Agent itself to drive a browser** → use Seple T Agent' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
