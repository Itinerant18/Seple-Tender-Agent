...
| | |
|---|---|
| 来源 | 可选 — 通过 `Seple T Agent skills install official/blockchain/solana` 安装 |
| 路径 | `optional-skills/blockchain/solana` |
| 版本 | `0.2.0` |
| 作者 | Deniz Alagoz (gizdusum)，由 Seple T Agent 增强 |
| 许可证 | MIT |
...
辅助脚本路径：~/.Seple T Agent/skills/blockchain/solana/scripts/solana_client.py
