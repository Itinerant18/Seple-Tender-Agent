#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Seple T Agent docs site.
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Seple T Agent as a Python Library", None),
        ("guides/use-mcp-with-hermes", "Use MCP with Seple T Agent", None),
        ("guides/use-voice-mode-with-hermes", "Use Voice Mode with Seple T Agent", None),
        ("guides/use-soul-with-hermes", "Use SOUL.md with Seple T Agent", None),
        ("guides/build-a-hermes-plugin", "Build a Seple T Agent Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Seple T Agent"),
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Seple T Agent — Full Documentation\n",
        (
            "This file is the entire Seple T Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Seple T Agent, Features, Messaging, Integrations, Guides, "
