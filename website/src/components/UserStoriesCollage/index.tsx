  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Seple T Agent community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Seple T Agent &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Seple T Agent?{' '}
        <a
          href="https://github.com/Novaedge/hermes-agent/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a href="https://discord.gg/Novaedge" target="_blank" rel="noopener noreferrer">
          Novaedge Discord
        </a>{' '}
